...
(** Nlmime contains high-level classes and functions to process
 ...
 * - {!Nlmime.printing}
 *
 * The tutorial has been moved to {!Nlmime_tut}.
 *)
...
object
  ...
  method content_type : 
     ...
     * with [Nlmimestring.param_value p = "utf-8"]. 
     *)
  ...
  method content_disposition : 
     ...
     * with [Nlmimestring.param_value p = "xy.dat"].
     *)
...
object
  ...
  method open_value_wr : unit -> out_obj_channel
     ...
     * let f_ch = new Nlchannels.input_file f in
...
val read_mime_header :
   ...
   * {[ 
   * let ch = new Nlchannels.input_channel (open_in "f") in
   * let stream = new Nlstream.input_stream ch in
 ...
 * {[ Nlmimestring.write_header ch h#fields ]}
 *
 * Link: {!Nlmimestring.write_header}
 *)
...
val decode_mime_body : #mime_header_ro -> out_obj_channel -> out_obj_channel
   ...
   *
   * {[ 
   * let ch_f = new Nlchannels.input_channel (open_in "f") in
   * let ch_g = new Nlchannels.output_channel (open_out "g") in
