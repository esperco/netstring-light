...
(* See also the module Nlmime for high-level MIME functions *)
...
val read_header :
     ...
     *
     * {[
     * let ch = new Nlchannels.input_channel (open_in "file.txt") in
...
val write_value :
     ...
     *   to [Nlconversion]. You can assume that UTF-8 and UTF-16 always
...
val scan_multipart_body_from_netstream
    : Nlstream.in_obj_stream ->
      ...
      add:('a -> Nlstream.in_obj_stream -> int -> int -> unit) ->
      stop:('a -> unit) ->
      unit
...
val read_multipart_body :
      (Nlstream.in_obj_stream -> 'a) -> string -> Nlstream.in_obj_stream ->
         'a list
